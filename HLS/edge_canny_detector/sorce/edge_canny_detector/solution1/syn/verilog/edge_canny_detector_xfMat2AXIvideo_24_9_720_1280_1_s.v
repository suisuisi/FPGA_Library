...
module edge_canny_detector_xfMat2AXIvideo_24_9_720_1280_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln197_reg_203;
reg    dst_TDATA_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln197_reg_203_pp0_iter1_reg;
reg   [10:0] j_reg_133;
reg   [0:0] sof_2_reg_144;
wire   [9:0] i_1_fu_159_p2;
reg   [9:0] i_1_reg_189;
wire    ap_CS_fsm_state2;
wire    regslice_both_AXI_video_strm_V_data_V_U_apdone_blk;
wire   [0:0] icmp_ln195_fu_165_p2;
...
reg   [0:0] sof_reg_119;
reg   [0:0] ap_phi_mux_sof_2_phi_fu_149_p4;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln195_fu_165_p2 == 1'd1) & (regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_condition_pp0_flush_enable)) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((icmp_ln195_fu_165_p2 == 1'd0) & (regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((ap_enable_reg_pp0_iter0 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter1_state4)) | ((icmp_ln195_fu_165_p2 == 1'd0) & (regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0) & (1'b1 == ap_CS_fsm_state2)))) begin
            ap_enable_reg_pp0_iter1 <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln195_fu_165_p2 == 1'd0) & (regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0) & (1'b1 == ap_CS_fsm_state2))) begin
        j_reg_133 <= 11'd0;
    end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln197_fu_177_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((icmp_ln197_reg_203_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        sof_2_reg_144 <= 1'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln197_fu_177_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln197_fu_177_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((icmp_ln195_fu_165_p2 == 1'd1) & (regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln197_reg_203_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
        ap_phi_mux_sof_2_phi_fu_149_p4 = 1'd0;
    end else begin
...
always @ (*) begin
    if ((((icmp_ln197_reg_203_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0)) | ((icmp_ln197_reg_203 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if (((icmp_ln197_reg_203 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln197_reg_203 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln197_reg_203_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (dst_TREADY_int_regslice == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln197_reg_203 == 1'd0) & (rgb_img_dst_4208_empty_n == 1'b0)) | ((icmp_ln197_reg_203 == 1'd0) & (dst_TREADY_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & ((1'b1 == ap_block_state5_io) | ((icmp_ln197_reg_203_pp0_iter1_reg == 1'd0) & (dst_TREADY_int_regslice == 1'b0)))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln197_reg_203 == 1'd0) & (rgb_img_dst_4208_empty_n == 1'b0)) | ((icmp_ln197_reg_203 == 1'd0) & (dst_TREADY_int_regslice == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state4_io = ((icmp_ln197_reg_203 == 1'd0) & (dst_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = (((icmp_ln197_reg_203 == 1'd0) & (rgb_img_dst_4208_empty_n == 1'b0)) | ((icmp_ln197_reg_203 == 1'd0) & (dst_TREADY_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_state5_io = ((icmp_ln197_reg_203_pp0_iter1_reg == 1'd0) & (dst_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state5_pp0_stage0_iter2 = ((icmp_ln197_reg_203_pp0_iter1_reg == 1'd0) & (dst_TREADY_int_regslice == 1'b0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign axi_last_V_fu_183_p2 = ((j_reg_133 == 11'd1279) ? 1'b1 : 1'b0);

assign dst_TVALID = regslice_both_AXI_video_strm_V_data_V_U_vld_out;

assign i_1_fu_159_p2 = (i_reg_108 + 10'd1);

assign icmp_ln195_fu_165_p2 = ((i_reg_108 == 10'd720) ? 1'b1 : 1'b0);

assign icmp_ln197_fu_177_p2 = ((j_reg_133 == 11'd1280) ? 1'b1 : 1'b0);

assign j_1_fu_171_p2 = (j_reg_133 + 11'd1);

endmodule //edge_canny_detector_xfMat2AXIvideo_24_9_720_1280_1_s
