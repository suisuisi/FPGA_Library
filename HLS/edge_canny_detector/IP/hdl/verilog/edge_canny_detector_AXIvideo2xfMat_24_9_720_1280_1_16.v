...
module edge_canny_detector_AXIvideo2xfMat_24_9_720_1280_1_16 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg   [0:0] icmp_ln132_reg_412;
reg    src_TDATA_blk_n;
wire    ap_CS_fsm_state2;
wire   [0:0] ap_phi_mux_start_phi_fu_179_p4;
reg    ap_enable_reg_pp1_iter0;
wire   [0:0] icmp_ln132_fu_376_p2;
wire   [0:0] or_ln138_fu_382_p2;
wire    ap_CS_fsm_state8;
wire   [0:0] ap_phi_mux_axi_last_V_9_phi_fu_319_p4;
reg    lowthreshold_blk_n;
reg    highthreshold_blk_n;
reg    lowthreshold_out_blk_n;
reg    highthreshold_out_blk_n;
reg   [10:0] j_reg_235;
reg   [0:0] last_reg_246;
reg   [0:0] start_3_reg_258;
reg   [23:0] axi_data_V_3_reg_269;
reg   [0:0] axi_last_V_3_reg_280;
reg   [0:0] axi_last_V_8_reg_290;
reg   [23:0] p_Val2_s_reg_303;
reg    ap_block_state2;
reg    ap_block_state8;
wire   [9:0] i_3_fu_358_p2;
reg   [9:0] i_3_reg_398;
wire    ap_CS_fsm_state4;
wire   [0:0] icmp_ln128_fu_364_p2;
wire   [10:0] j_3_fu_370_p2;
...
reg   [0:0] axi_last_V_reg_151;
reg   [23:0] axi_data_V_reg_163;
reg   [0:0] start_reg_175;
reg    ap_block_state1;
reg   [9:0] i_reg_186;
wire    ap_CS_fsm_state9;
wire    ap_CS_fsm_state3;
reg   [0:0] start_2_reg_197;
reg   [23:0] axi_data_V_4_reg_326;
reg   [23:0] axi_data_V_2_reg_211;
reg   [0:0] axi_last_V_2_reg_222;
reg   [0:0] ap_phi_mux_last_phi_fu_250_p4;
reg   [0:0] ap_phi_mux_start_3_phi_fu_261_p4;
reg   [23:0] ap_phi_mux_axi_data_V_3_phi_fu_272_p4;
reg   [0:0] ap_phi_mux_axi_last_V_3_phi_fu_283_p4;
wire   [0:0] ap_phi_reg_pp1_iter0_axi_last_V_8_reg_290;
wire   [23:0] ap_phi_reg_pp1_iter0_p_Val2_s_reg_303;
reg   [0:0] axi_last_V_9_reg_316;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln128_fu_364_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b1 == ap_condition_pp1_exit_iter0_state5))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln128_fu_364_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln128_fu_364_p2 == 1'd0))) begin
        axi_data_V_3_reg_269 <= axi_data_V_2_reg_211;
    end else if (((icmp_ln132_reg_412 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((src_TVALID_int_regslice == 1'b0) & (axi_last_V_9_reg_316 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (axi_last_V_9_reg_316 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_180)) begin
        if (((or_ln138_fu_382_p2 == 1'd1) & (icmp_ln132_fu_376_p2 == 1'd0))) begin
            axi_last_V_8_reg_290 <= ap_phi_mux_axi_last_V_3_phi_fu_283_p4;
        end else if (((or_ln138_fu_382_p2 == 1'd0) & (icmp_ln132_fu_376_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln128_fu_364_p2 == 1'd0))) begin
        j_reg_235 <= 11'd0;
    end else if (((ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0) & (icmp_ln132_fu_376_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        start_2_reg_197 <= 1'd1;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
        start_2_reg_197 <= 1'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((highthreshold_out_full_n == 1'b0) | (lowthreshold_out_full_n == 1'b0) | (highthreshold_ap_vld == 1'b0) | (lowthreshold_ap_vld == 1'b0) | (ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        start_reg_175 <= 1'd0;
    end else if ((~((start_reg_175 == 1'd0) & (src_TVALID_int_regslice == 1'b0)) & (start_reg_175 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        start_reg_175 <= src_TUSER_int_regslice;
    end
end

always @ (posedge ap_clk) begin
    if ((~((start_reg_175 == 1'd0) & (src_TVALID_int_regslice == 1'b0)) & (start_reg_175 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((icmp_ln132_fu_376_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln128_fu_364_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln132_reg_412 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln132_reg_412 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ap_phi_mux_start_3_phi_fu_261_p4 = 1'd0;
    end else begin
...
always @ (*) begin
    if (((icmp_ln132_reg_412 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (or_ln138_fu_382_p2 == 1'd0) & (icmp_ln132_fu_376_p2 == 1'd0)) | ((start_reg_175 == 1'd0) & (1'b1 == ap_CS_fsm_state2)) | ((1'b1 == ap_CS_fsm_state8) & (axi_last_V_9_reg_316 == 1'd0)))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op122_read_state5 == 1'b1)) | (~((src_TVALID_int_regslice == 1'b0) & (axi_last_V_9_reg_316 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (axi_last_V_9_reg_316 == 1'd0)) | (~((start_reg_175 == 1'd0) & (src_TVALID_int_regslice == 1'b0)) & (start_reg_175 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~((start_reg_175 == 1'd0) & (src_TVALID_int_regslice == 1'b0)) & (start_reg_175 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if ((~((start_reg_175 == 1'd0) & (src_TVALID_int_regslice == 1'b0)) & (ap_phi_mux_start_phi_fu_179_p4 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone) & (icmp_ln132_fu_376_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone) & (icmp_ln132_fu_376_p2 == 1'd1))) begin
        ...
        ap_ST_fsm_state8 : begin
            if ((~((src_TVALID_int_regslice == 1'b0) & (axi_last_V_9_reg_316 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (axi_last_V_9_reg_316 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end else if ((~((src_TVALID_int_regslice == 1'b0) & (axi_last_V_9_reg_316 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (ap_phi_mux_axi_last_V_9_phi_fu_319_p4 == 1'd1))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((ap_enable_reg_pp1_iter0 == 1'b1) & (src_TVALID_int_regslice == 1'b0) & (ap_predicate_op122_read_state5 == 1'b1)) | ((icmp_ln132_reg_412 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (rgb_img_src_4206_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((ap_enable_reg_pp1_iter0 == 1'b1) & (src_TVALID_int_regslice == 1'b0) & (ap_predicate_op122_read_state5 == 1'b1)) | ((icmp_ln132_reg_412 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (rgb_img_src_4206_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((ap_enable_reg_pp1_iter0 == 1'b1) & (src_TVALID_int_regslice == 1'b0) & (ap_predicate_op122_read_state5 == 1'b1)) | ((icmp_ln132_reg_412 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (rgb_img_src_4206_full_n == 1'b0)));
end
...
always @ (*) begin
    ap_block_state2 = ((start_reg_175 == 1'd0) & (src_TVALID_int_regslice == 1'b0));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = ((icmp_ln132_reg_412 == 1'd0) & (rgb_img_src_4206_full_n == 1'b0));
end

always @ (*) begin
    ap_block_state8 = ((src_TVALID_int_regslice == 1'b0) & (axi_last_V_9_reg_316 == 1'd0));
end
...
assign ap_phi_mux_axi_last_V_9_phi_fu_319_p4 = axi_last_V_9_reg_316;

assign ap_phi_mux_start_phi_fu_179_p4 = start_reg_175;

assign ap_phi_reg_pp1_iter0_axi_last_V_8_reg_290 = 'bx;

assign ap_phi_reg_pp1_iter0_p_Val2_s_reg_303 = 'bx;

always @ (*) begin
    ap_predicate_op122_read_state5 = ((or_ln138_fu_382_p2 == 1'd0) & (icmp_ln132_fu_376_p2 == 1'd0));
end
...
assign i_3_fu_358_p2 = (i_reg_186 + 10'd1);

assign icmp_ln128_fu_364_p2 = ((i_reg_186 == 10'd720) ? 1'b1 : 1'b0);

assign icmp_ln132_fu_376_p2 = ((j_reg_235 == 11'd1280) ? 1'b1 : 1'b0);

assign j_3_fu_370_p2 = (j_reg_235 + 11'd1);

assign lowthreshold_out_din = lowthreshold;

assign or_ln138_fu_382_p2 = (ap_phi_mux_start_3_phi_fu_261_p4 | ap_phi_mux_last_phi_fu_250_p4);

assign rgb_img_src_4206_din = p_Val2_s_reg_303;

assign src_TREADY = regslice_both_AXI_video_strm_V_data_V_U_ack_in;

assign start_out = real_start;

endmodule //edge_canny_detector_AXIvideo2xfMat_24_9_720_1280_1_16
